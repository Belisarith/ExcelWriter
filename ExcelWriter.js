...
// /docProps/app.xml
const docpropsappString =
  '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>  <Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><TotalTime>0</TotalTime><Application>Microsoft Excel</Application><DocSecurity>0</DocSecurity><ScaleCrop>false</ScaleCrop><HeadingPairs><vt:vector size="2" baseType="variant"><vt:variant><vt:lpstr>Arbeitsblätter</vt:lpstr></vt:variant><vt:variant><vt:i4>1</vt:i4></vt:variant></vt:vector></HeadingPairs><TitlesOfParts><vt:vector size="1" baseType="lpstr"><vt:lpstr>Tabelle1</vt:lpstr></vt:vector></TitlesOfParts><Company></Company><LinksUpToDate>false</LinksUpToDate><SharedDoc>false</SharedDoc><HyperlinksChanged>false</HyperlinksChanged><AppVersion>16.0300</AppVersion></Properties>';

// /docProps/core.xml
const docpropscoreString =
  '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:creator></dc:creator><cp:lastModifiedBy></cp:lastModifiedBy><dcterms:created xsi:type="dcterms:W3CDTF">2015-06-05T18:19:34Z</dcterms:created><dcterms:modified xsi:type="dcterms:W3CDTF">2018-04-28T16:09:05Z</dcterms:modified></cp:coreProperties>';

// /xl/styles.xml
const stylesString =
  '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac x16r2 xr" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac" xmlns:x16r2="http://schemas.microsoft.com/office/spreadsheetml/2015/02/main" xmlns:xr="http://schemas.microsoft.com/office/spreadsheetml/2014/revision"><fonts count="1" x14ac:knownFonts="1"><font><sz val="11"/><color theme="1"/><name val="Calibri"/><family val="2"/><scheme val="minor"/></font></fonts><fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill></fills><borders count="1"><border><left/><right/><top/><bottom/><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/></cellXfs><cellStyles count="1"><cellStyle name="Standard" xfId="0" builtinId="0"/></cellStyles><dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium2" defaultPivotStyle="PivotStyleLight16"/><extLst><ext uri="{EB79DEF2-80B8-43e5-95BD-54CBDDF9020C}" xmlns:x14="http://schemas.microsoft.com/office/spreadsheetml/2009/9/main"><x14:slicerStyles defaultSlicerStyle="SlicerStyleLight1"/></ext><ext uri="{9260A510-F301-46a8-8635-F512D64BE5F5}" xmlns:x15="http://schemas.microsoft.com/office/spreadsheetml/2010/11/main"><x15:timelineStyles defaultTimelineStyle="TimeSlicerStyleLight1"/></ext></extLst></styleSheet>';

// /xl/workbooks.xml
const workbooksString =
  '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x15 xr xr6 xr10 xr2" xmlns:x15="http://schemas.microsoft.com/office/spreadsheetml/2010/11/main" xmlns:xr="http://schemas.microsoft.com/office/spreadsheetml/2014/revision" xmlns:xr6="http://schemas.microsoft.com/office/spreadsheetml/2016/revision6" xmlns:xr10="http://schemas.microsoft.com/office/spreadsheetml/2016/revision10" xmlns:xr2="http://schemas.microsoft.com/office/spreadsheetml/2015/revision2"><fileVersion appName="xl" lastEdited="7" lowestEdited="6" rupBuild="19126"/><workbookPr filterPrivacy="1"/><xr:revisionPtr revIDLastSave="0" documentId="12_ncr:500000_{3B63BBC1-22C2-4DD2-9ED3-06F5C4328210}" xr6:coauthVersionLast="31" xr6:coauthVersionMax="31" xr10:uidLastSave="{00000000-0000-0000-0000-000000000000}"/><bookViews><workbookView xWindow="0" yWindow="0" windowWidth="22260" windowHeight="12647" xr2:uid="{00000000-000D-0000-FFFF-FFFF00000000}"/></bookViews><sheets><sheet name="Tabelle1" sheetId="1" r:id="rId1"/></sheets><calcPr calcId="162913"/><extLst><ext uri="{140A7094-0E35-4892-8432-C4D2E57EDEB5}" xmlns:x15="http://schemas.microsoft.com/office/spreadsheetml/2010/11/main"><x15:workbookPr chartTrackingRefBase="1"/></ext></extLst></workbook>';

// /xl/_rels/workbook.xml.rels
const workbookxmlrelsString =
...
class ExcelWriter {
  constructor() {
    this.maxRows = 0;
    this.maxCols = 0;
    this.numUniqueStrings = 0;
    this.numStrings = 0;
    this.uniqueStrings = {};
    this.rowsData = []; // the structure shall be etc [[{Data: row1Col1Data, Type: "string"},{Data: row1Col2Data, Type: "number"},....],[{Data: null, Type: "None"},....]]: null indicates that cell is empty
    this.colnumbertocolletter = this.colnumbertocolletter.bind(this);
    this.save = this.save.bind(this);
    this.addRow = this.addRow.bind(this);
    this.createSharedStringsXML = this.createSharedStringsXML.bind(this);
  ...
  createSheetXML() {
    let sheetXML = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac xr xr2 xr3" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac" xmlns:xr="http://schemas.microsoft.com/office/spreadsheetml/2014/revision" xmlns:xr2="http://schemas.microsoft.com/office/spreadsheetml/2015/revision2" xmlns:xr3="http://schemas.microsoft.com/office/spreadsheetml/2016/revision3" xr:uid="{00000000-0001-0000-0000-000000000000}"><dimension ref="A1:${this.colnumbertocolletter(
      this.maxCols
    )}${
      this.maxRows
    }"/><sheetViews><sheetView tabSelected="1" workbookViewId="0"><selection activeCell="A1" sqref="A1"/></sheetView></sheetViews><sheetFormatPr baseColWidth="10" defaultColWidth="8.9375" defaultRowHeight="14.35" x14ac:dyDescent="0.5"/><sheetData>`;
    let rownum = 0;
    let colnum = 0;
    this.rowsData.forEach(row => {
      rownum++;
      colnum = 0;
      sheetXML += `<row r="${rownum}" spans="1:${
        this.maxCols
      }" x14ac:dyDescent="0.5">`;
      row.forEach(col => {
        colnum++;
        if (col.Type === "number" && col.Data !== null)
          sheetXML += `<c r="${this.colnumbertocolletter(
            colnum
          )}${rownum}"><v>${col.Data}</v></c>`;
        else {
          sheetXML += `<c r="${this.colnumbertocolletter(
            colnum
          )}${rownum}" t="s"><v>${this.uniqueStrings[col.Data]}</v></c>`;
        }
      });
      sheetXML += `</row>`;
    });
  ...
  //returns string /xl/worksheets/sheet1.xml
  createSharedStringsXML() {
    let sharedString = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><sst xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" count="${
      this.numStrings
    }" uniqueCount="${this.numUniqueStrings}">`;
    let positions = {};
    Object.keys(this.uniqueStrings).forEach(uniqueString => {
  ...
  colnumbertocolletter(number) {
    ...
    if (number <= alphabet.length) return alphabet[number - 1];
    else {
      let alength = alphabet.length;

      let firstletter = alphabet[Math.floor(number / alength) - 1];
      let secondletter = alphabet[number % alength - 1];
  ...
  save(filename) {
    let zip = new JSZip();
    zip.file("[Content_Types].xml", contenttypesString);
    zip.file("_rels/.rels", relsString);
    zip.file("docProps/app.xml", docpropsappString);
    zip.file("docProps/core.xml", docpropscoreString);
    zip.file("xl/_rels/workbook.xml.rels", workbookxmlrelsString);
    zip.file("xl/theme/theme1.xml", themeString);
    zip.file("xl/styles.xml", stylesString);
    zip.file("xl/workbook.xml", workbooksString);

    //This is were the magic happens and the actual information is stored
    zip.file("xl/worksheets/sheet1.xml", this.createSheetXML());
    zip.file("xl/sharedStrings.xml", this.createSharedStringsXML());
